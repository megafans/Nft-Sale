import { ArrowRightOnRectangleIcon, PlusIcon, ChevronRightIcon, ArrowLongRightIcon } from '@heroicons/react/24/solid'
...
export const NoAccess = () => {
  return (
    <div className="mx-auto max-w-2xl py-16 sm:py-24 px-2">
      ...
      <div className="mt-12">
        <h2 className="text-xl font-semibold text-white text-center">Popular pages</h2>
          ...
          {links.map(link => (
            <li key={link.id} className="relative flex items-start space-x-4 py-6">
              <div className="flex-shrink-0">
                <span className="flex h-12 w-12 items-center justify-center rounded-lg bg-white/40">
                  <link.icon className="h-6 w-6 text-purple" aria-hidden="true" />
                </span>
              </div>
              <div className="min-w-0 flex-1">
                <h3 className="text-base font-bold text-gray-200 uppercase">
