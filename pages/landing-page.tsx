...
const AboutSection = () => (
  ...
  >
    <Image
      src={megafansLabel}
      width={megafansLabel.width}
      height={megafansLabel.height}
      alt="Megafans-header"
      className="mb-5"
    />
    <div className="flex max-md:flex-col">
      <div className="flex-1 basis-full self-center" style={{ padding: '10px' }}>
        <div className="flex flex-col">
          ...
          >
            MegaFans is building and supporting the world’s first esports community using blockchain products; Utility
            cryptocurrency and NFTs with a novel Stake-to-Earn + Play-to-Win environment for gamers, collectors,
          ...
          >
            <h3 className="mb-4">Supply : TDB</h3>
            <h3>Price: TBD</h3>
          </div>
      ...
      <div className="flex-1 basis-full" style={{ padding: '10px' }}>
        <Image src={nftLady} width={nftLady.width} height={nftLady.height} alt="nft-girl" />
      </div>
    </div>
  </div>
)
    ...
    <div className="flex mix-blend-lighten align-middle justify-center relative px-44">
      <div className="relative z-0 mb-8">
        <Image
          ...
          width={208}
          alt="gun-left"
          className="-left-48 absolute -z-10 object-contain top-1/2 -translate-y-1/2 max-lg:-left-36"
        />
        ...
        <Image
          ...
          width={208}
          alt="gun-left"
          className="-right-48 absolute -z-10 object-contain top-1/2 -translate-y-1/2 max-lg:-right-36"
        />
      </div>
    </div>
